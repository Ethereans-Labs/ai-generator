...
async def chat(
    ...
    try:
        ...
        chat_engine.callback_manager.handlers.append(
            ...
            async def _event_generator():
                async for event in event_handler.async_event_gen():
                    ...
                    if event_response is not None:
                        yield StreamingResponse(event_response)
        ...
        return StreamingResponse(content=content_generator())
