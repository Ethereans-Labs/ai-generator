...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            context.subscriptions.push(vscode.window.registerWebviewViewProvider("kaiten.extensionSidebarView", new ColorsViewProvider(context)));
        }
        catch (error) {
...
function createWebviewPanel(context, accessToken) {
    ...
    const scriptSrc = panel.webview.asWebviewUri(vscode.Uri.joinPath(context.extensionUri, "media", "build", "static", "js", "main.4084cb98.js"));
    const cssSrc = panel.webview.asWebviewUri(vscode.Uri.joinPath(context.extensionUri, "media", "build", "static", "css", "main.85e14ac8.css"));
    ...
    resolveWebviewView(webviewView, context, token) {
        ...
        this._view.webview.onDidReceiveMessage((message) => __awaiter(this, void 0, void 0, function* () {
            switch (message.command) {
                ...
                case 'debugCommand':
                    if (contractFileName != '') {
                        var files = yield vscode.workspace.findFiles(`**/${contractFileName}`, "**/node_modules/**", 1);
                        if (files.length === 0) {
                            ...
                            try {
                                ...
                                const compiledContract = yield multiverse.compile(contractPath, "contract", "0.8.0", false);
